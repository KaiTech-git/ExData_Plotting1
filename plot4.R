...
with(Data, plot(DateTime, Voltage, type = "l", xlab = "datetime")) # second plot
...
legend(col = c("black", "red", "blue"), lty = 1,  
       legend =c( "Sub_metering_1", "Sub_metering_2", "Sub_metering_3")  , "topright", cex = 0.5, bty ="n")
with(Data, plot(DateTime, Global_reactive_power, type = "l", xlab = "datetime")) #4th plot
